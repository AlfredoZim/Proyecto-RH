...
function iniciaElementosGuardado(){
    let elementos = [document.getElementById('nombre'),
            document.getElementById('paterno'),
            document.getElementById('materno'),
...
function llenaModificar(){
    ...
    if(indexModificar > -1){
        ...
        document.getElementById('paterno').value = seleccionado['paterno'];
        document.getElementById('materno').value = seleccionado['materno'];
